...
package com.tinytongtong.eyepetizertest.extension
...
import com.tinytongtong.eyepetizertest.MyApplication
...
fun CharSequence.preCreateSession(): Boolean {
    if (!SonicEngine.isGetInstanceAllowed()) {
        SonicEngine.createInstance(SonicRuntimeImpl(MyApplication.context), SonicConfig.Builder().build())
    }
